...
export const FIXED_ACCOUNTS: TestAccount[] = [
  // ── Official Beyon Platform Admins ──
  {
  ...
  {
    id: "beyon-verifier-0001",
    email: "verifier@beyon.io",
  ...
  {
    id: "beyon-contentadmin-0001",
    email: "skillcontent@beyon.io",
    password: "Skillcontent@2026",
    name: "Content & Skill Administrator",
    role: "CONTENT_ADMIN",
    status: "ACTIVE",
    emailVerified: true,
  },
  {
    id: "beyon-questionsetter-0001",
    email: "questionsetter@beyon.io",
    password: "Questionsetter@2026",
  ...
  {
    id: "beyon-supportadmin-0001",
    email: "supportadmin@beyon.io",
    password: "Supportadmin@2026",
    name: "Support & Moderation Administrator",
    role: "MODERATION_ADMIN",
    status: "ACTIVE",
    emailVerified: true,
  },
  {
    id: "beyon-analytics-0001",
    email: "analytics@beyon.io",
  ...
  // ── Test & Staging Accounts ──
  {
    ...
    status: "ACTIVE",
    emailVerified: true,
    institutionKey: "INST_KEC",
    persona: "A",
    extraData: { cgpa: 8.85, coins: 2450, placement_preference: "PLACEMENT_WILLING", department: "CSE", graduation_year: 2027, registration_number: "23CSR068" },
  },
  {
    id: "gowtham-student-0002",
    email: "gowthamcdstudies@gmail.com",
    password: "Password@123",
    name: "Gowtham C D",
    role: "STUDENT",
    status: "ACTIVE",
  ...
  {
    id: "beyon-inst-kec-official",
    email: "konguengineeringcollege@kongu.edu",
    password: "Password@123",
    name: "Kongu Engineering College",
    role: "INSTITUTION",
    status: "ACTIVE",
  ...
  {
    id: "beyon-admin-test-0001",
    email: "admin@example.beyon.test",
    password: "BeyonTest!2026#Admin",
    name: "Platform Administrator (Test)",
    role: "ADMIN",
    status: "ACTIVE",
    emailVerified: true,
  },
  {
    id: "beyon-moderator-test-0001",
