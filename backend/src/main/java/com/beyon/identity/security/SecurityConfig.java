    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/drives/public").permitAll()
                .requestMatchers("/api/v1/drives/**").authenticated()
                .requestMatchers("/api/v1/opportunities/public").permitAll()
                ...
                .requestMatchers("/api/v1/project-evaluations/**").authenticated()
