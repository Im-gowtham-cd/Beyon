...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    java.util.List<User> findByInstitutionIdAndDepartmentId(UUID institutionId, String departmentId);
    java.util.List<User> findByInstitutionIdAndRole(UUID institutionId, com.beyon.identity.enums.UserRole role);
