          ...
          {deptPerformances.map((d, idx) => (
            <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
              ...
              >
                ...
                <span>
                  <strong style={{ color: '#15803d' }}>{d.placedPct}% Placed</strong> &middot;{' '}
                  <span style={{ color: '#64748b' }}>Avg {d.avgSalary}</span>
                </span>
              </div>
              <div
                style={{
            ...
            <tbody>
              {nirfParameters.map((p, idx) => (
                <tr key={idx} style={{ borderBottom: '1px solid #f1f5f9' }}>
                  ...
                  <td style={{ padding: '10px 14px', color: '#64748b', fontWeight: 400 }}>{p.weight}</td>
